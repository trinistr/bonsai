...
describe Bonsai::Generate do
  describe "generator" do
    ...
    it "should copy the htaccess file to public/.htaccess" do
      File.exist?("#{@path}/public/.htaccess").should be true
    end
    
    it "should copy the base.scss file" do
      File.exist?("#{@path}/public/css/base.scss").should be true
    end
    
    it "should copy an index page" do
      File.exist?("#{@path}/content/index/default.yml").should be true
    end
    
    it "should copy a default template" do
      File.exist?("#{@path}/templates/default.liquid").should be true
    end
    
    it "should create a robots.txt" do
      File.exist?("#{@path}/public/robots.txt").should be true
    end
    
    it "should create a site.yml" do
      File.exist?("#{@path}/site.yml").should be true
    end
